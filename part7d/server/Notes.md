...
Something to notice here is that dist here is not being used in part 4 becuase you will have to do `app.use(express.static('dist'))` to serve it. I did this in the Phonebook app but not here, I think I used CORS and setup the backend, frontend separately
